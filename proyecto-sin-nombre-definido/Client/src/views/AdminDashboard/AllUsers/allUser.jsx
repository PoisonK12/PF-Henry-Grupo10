        ...
        <tbody>
          {filteredUsers.length > 0 ? (
            filteredUsers.map((ele, index) => (
              <tr key={ele.id} >
                <th style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }}  scope="row">{index + 1}</th>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} ><img src={ele.profilePic} alt="" style={{ width: "35px", height: "35px", borderRadius: "100%" }} /></td>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} >{ele.userName}</td>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} >{ele.address}</td>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} >{ele.email}</td>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} >{ele.phoneNumber}</td>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} >{ele.nationality}</td>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} >{ele.userType}</td>
                <td style={{ backgroundColor: ele.hide ? '#edd55e' : '#9bdb92' }} >
                  <button className="btn btn-outline-danger" onClick={(e) => handleDelete(e, ele.id)}>
                  ...
                  <button className="btn btn-outline-warning" onClick={(e) => handlePauseUser(e, ele.id)}>
                  ...
                  <button className="btn btn-outline-success" onClick={(e) => handlerRestoreUser(e, ele.id)}>
