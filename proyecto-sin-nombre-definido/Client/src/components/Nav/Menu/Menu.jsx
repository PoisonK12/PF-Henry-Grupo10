              ...
              >
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                    <li class="nav-item">
                      <a class="nav-link active" aria-current="page" href="#" style={{display: "flex",justifyContent: "center", alignItems: "center", paddingRight: "15px"}}>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style={{display: "flex", alignItems: "center",height: "35px", }}>
                            <div>
                        <Link to={'/addProperty'}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-house-add-fill" viewBox="0 0 16 16">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#" style={{paddingLeft: "45px"}}>
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#"  style={{paddingLeft: "45px"}}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-layout-text-window-reverse" viewBox="0 0 16 16">
