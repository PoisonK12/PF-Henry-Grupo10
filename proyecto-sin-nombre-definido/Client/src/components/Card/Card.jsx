                ...
                <div className="card-body">
                  ...
                  <ul className="list-unstyled list-inline mb-0">
                    <li className="list-inline-item me-0">
                      <i className="fas fa-star text-primary fa-xs"> • Bathroom 🛀 {bathrooms}</i>
                    </li>
                    <li className="list-inline-item me-0">
                      <i className="fas fa-star text-primary fa-xs"> • Rooms 🛌 {rooms}</i>
                    </li>
                    <li className="list-inline-item me-0">
                      <i className="fas fa-star text-primary fa-xs"> • House Mt2 🏠 {coveredArea}</i>
                    </li>
                    <li className="list-inline-item me-0">
                      <i className="fas fa-star text-primary fa-xs"> • Area 🌱 {totalArea}</i>
                    </li>
                    <li className="list-inline-item">
                      <i className="fas fa-star-half-alt text-primary fa-xs"> • Person 🧑🏽‍💼 {perPerson}</i>
                    </li>
