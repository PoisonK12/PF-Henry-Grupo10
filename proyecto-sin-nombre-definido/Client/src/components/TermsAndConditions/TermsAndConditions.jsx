    ...
    return (
        <div style={{padding : "100px"}}>
            <h2 style={{textAlign: "center"}}>
                ...
                <p>Este localHost:3001 garantiza que la <a href="https://noticias-fcbarcelona.es/" target="_blank">fc barcelona noticias</a> información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.</p>
                ...
                <p>Gravel Travel reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
                <p>Estas terminos y condiciones se han generado en&nbsp;<a href="http://terminosycondicionesdeusoejemplo.com/" target="_blank">terminosycondicionesdeusoejemplo.com</a>.</p>
        </div>
    )
};
